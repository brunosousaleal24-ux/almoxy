import { Product, StockMovement, Supplier, AppSettings, ConstructionSite, ToolCaution, Employee } from '../types';
...
export const INITIAL_EMPLOYEES: Employee[] = [
  {
    ...
    name: 'Carlos Borges',
    cpf: '123.456.789-00',
    registrationNumber: 'MAT-0101',
    role: 'Almoxarife Chefe',
    sector: 'Almoxarifado',
    phone: '(11) 98765-1001',
    email: 'carlos.borges@borgesgomes.com.br',
    active: true,
    notes: 'Responsável principal pela conferência e entrada de notas fiscais.',
  ...
  },
  {
    ...
    name: 'Marcos Gomes',
    cpf: '234.567.890-11',
    registrationNumber: 'MAT-0102',
    role: 'Eletricista Predial',
    sector: 'Elétrica',
    phone: '(11) 98765-1002',
    email: 'marcos.gomes@borgesgomes.com.br',
    active: true,
    notes: 'Certificação NR-10 e NR-35 em dia.',
  ...
  },
  {
    ...
    cpf: '345.678.901-22',
    registrationNumber: 'MAT-0103',
    role: 'Mestre de Obras',
    sector: 'Obras & Construção Civil',
    phone: '(11) 98765-1003',
    email: 'roberto.albuquerque@borgesgomes.com.br',
    active: true,
    notes: 'Coordenação geral de frentes de trabalho da Torre Skyline.',
  ...
  },
  {
    ...
    cpf: '456.789.012-33',
    registrationNumber: 'MAT-0104',
    role: 'Engenheira Civil',
    sector: 'Engenharia',
    phone: '(11) 98765-1004',
    email: 'beatriz.siqueira@borgesgomes.com.br',
    active: true,
    notes: 'Gestora técnica das obras Aurora Plaza e Galpão Sul.',
  ...
  },
  {
    ...
    name: 'Lucas Silva',
    cpf: '567.890.123-44',
    registrationNumber: 'MAT-0105',
    role: 'Encanador Industrial',
    sector: 'Hidráulica',
    phone: '(11) 98765-1005',
    email: 'lucas.silva@borgesgomes.com.br',
    active: true,
    notes: 'Instalações de tubulações PPR, CPVC e barriletes.',
  ...
  },
  {
    ...
    cpf: '678.901.234-55',
    registrationNumber: 'MAT-0106',
    role: 'Pedreiro Especialista',
    sector: 'Obras & Construção Civil',
    phone: '(11) 98765-1006',
    email: 'roberto.ferreira@borgesgomes.com.br',
    active: true,
    notes: 'Execução de alvenaria estrutural e acabamento fino.',
